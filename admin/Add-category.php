            ...
            <div class="form first">
              <div class="details personal">
                ...
                <div class="input-field">
                  <label>Genres : </label>
                  <input type="text" placeholder="language" name="genres" required>
                </div>
    ...
    $(document).ready(function() {
      ...
      $("#form").submit(function(e) {
        ...
        if (jsonobj == false) {
          ...
          $.ajax({
            type: "POST",
            url: "http://localhost/Tvflix/admin/controls/insert-genres.php",
            data: jsonobj,
